...
class OpenAICompatibleBackend(LLMBackend):
    def __init__(self, *, base_url: str, api_key: str,
                 ...
                 embed_dim: int | None = None, send_dimensions: bool = False):
        ...
        # Qwen Cloud's text-embedding-v4 needs dimensions=768 requested
        # explicitly (defaults to 1024). Ollama doesn't take the parameter.
    ...
    def embed(self, texts: list[str]) -> list[list[float]]:
        kwargs = {}
        if self.send_dimensions and self.embed_dim:
